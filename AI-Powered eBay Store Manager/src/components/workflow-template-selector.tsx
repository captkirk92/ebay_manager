...
import { Clock, Settings, ArrowRight, Search, Filter } from "lucide-react";
import {
  WORKFLOW_TEMPLATES,
  WORKFLOW_CATEGORIES,
  WorkflowTemplate,
    ...
    <div className="w-full max-w-6xl mx-auto space-y-6">
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-muted-foreground">
          Select a pre-made workflow that matches your store type, or create a
          custom one
        </p>
      </div>
        ...
        <CardContent className="flex items-center justify-center py-8">
          <div className="text-center space-y-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Create a personalized workflow tailored to your specific
                business needs
              </p>
            </div>
