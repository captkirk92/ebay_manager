...
import { Bot, Send, Sparkles, AlertTriangle, TrendingUp, Package, MessageSquare, X, Minimize2, Maximize2 } from "lucide-react";
...
export function AIAssistant({ isExpanded = false, onToggle }: AIAssistantProps) {
  ...
  return (
    <Card className="fixed bottom-6 right-6 w-96 h-[500px] z-50 shadow-2xl border-2 border-blue-600/20 bg-background/95 backdrop-blur">
      <CardHeader className="pb-3 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-b">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <CardTitle className="text-sm">AI Co-Manager</CardTitle>
