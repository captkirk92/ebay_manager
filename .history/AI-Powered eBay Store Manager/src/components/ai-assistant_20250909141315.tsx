...
export function AIAssistant({ isExpanded = false, onToggle }: AIAssistantProps) {
  ...
  const generateIntelligentInsights = () => {
    ...
    insights.push({
      id: 'welcome',
      type: 'ai',
      content: `👋 Hello! I'm your AI Co-Manager for **${storeSummary?.store_name || 'your eBay store'}**. I've analyzed your live store data and found several opportunities to improve your performance.`,
