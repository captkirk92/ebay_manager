...
def main():
    ...
    parser.add_argument('--analyze-order', type=str, help='Analyze specific order by ID')
    parser.add_argument('--order-health', action='store_true', help='Get store-wide order health report')
    ...
    elif args.analyze_order:
        result = analyze_order(args.analyze_order)
    elif args.order_health:
        result = get_order_health_report()
    else:
